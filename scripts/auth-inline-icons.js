/**
 * Iconos SVG estáticos (trazos tomados de Lucide v0.460.0, licencia ISC)
 * para páginas auth sin cargar lucide desde CDN.
 */

function svg(inner) {
  return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="auth-icon" aria-hidden="true">${inner}</svg>`;
}

/** Mapa nombre kebab (atributo data-lucide) → fragmento SVG */
export const ICON = {
  "shield-check": svg(
  ...
  "lock-keyhole": svg(`<circle cx="12" cy="16" r="1"/><rect x="3" y="10" width="18" height="12" rx="2"/><path d="M7 10V7a5 5 0 0 1 10 0v3"/>`),
  "life-buoy": svg(
 ...
 */
export function hydrateAuthIconPlaceholders(root = document) {
